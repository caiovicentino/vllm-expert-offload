...
class EngineArgs:
    ...
    moe_expert_cache_policy: str = OffloadConfig.moe_expert_cache_policy
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        offload_group.add_argument(
            "--moe-expert-cache-policy", **offload_kwargs["moe_expert_cache_policy"]
        )
    ...
    def create_engine_config(
        ...
        offload_config = OffloadConfig(
            ...
            moe_expert_cache_policy=self.moe_expert_cache_policy,
        )
